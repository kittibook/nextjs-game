...
export default function PointImageAndAnswerGame5(prop: Prop) {
                        ...
                        <div>
                             <div className="flex flex-col gap-2">
                                <div className="w-full flex justify-center">
                                    <FaVolumeUp
                                        onClick={e => playAudio(Config.url + prop.detail.problems)}
                                        className="text-blue-500  text-lg md:text-2xl w-24 h-24"
                                    />
                                </div>
