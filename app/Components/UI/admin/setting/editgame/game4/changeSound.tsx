...
export default function ChangeSoundGame4(prop: Prop) {
    ...
    const submit = async () => {
        try {
            ...
            fromData.append('answer', detail.answer)
            fromData.append('file', File);

            const res = await putAuthFormData('/admin/setting/sound-match-setting', fromData)
            if (res.success) {
                ...
                <div className="flex flex-col gap-2">
                    <div className="w-full flex justify-center">
                        <FaVolumeUp
                            ...
                            className="text-blue-500 text-lg md:text-2xl w-24 h-24 lg:w-48 lg:h-48"
                        />
                    </div>
                    ...
                    <div >
                        ...
                        <div className="lg:px-4 px-0 py-2 bg-main/20 transition delay-100 hover:bg-main/50 relative">
